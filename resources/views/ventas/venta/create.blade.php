...
<div class="col-lg-6 col-md-6 col-dm-6 col-xs-12" id="guardar1">
	<div class="form-group">
		...
		<button id="guardar" onclick="validastate()" class="btn btn-primary"  type="submit">Guardar <i class="fa fa-floppy-o"></i></button>
		<button class="btn btn-danger" type="reset">Restablecer <i class="fa fa-repeat"></i></button>
		<a class="btn btn-primary" href="/ventas/venta" role="button">Cancelar <i class="fa fa-ban"></i></a>
			</div>
		</div>
	</div>
   		{!!Form::close()!!}  
